...
template <typename Dtype>
class WeightedHingeLossLayer : public LossLayer<Dtype> {
 public:
  explicit WeightedHingeLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}

  virtual inline const char* type() const { return "WeightedHingeLossLayer"; }
...
template <typename Dtype>
class MulticlassHingeLossLayer : public LossLayer<Dtype> {
 public:
  explicit MulticlassHingeLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}

  virtual inline const char* type() const { return "MulticlassHingeLoss"; }
